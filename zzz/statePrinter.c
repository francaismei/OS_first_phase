...
short SPPrintLine(SP_INPUT_DATA *Input) {
    ...
    SPLineSetup(OutputLine, "SUS-DSK1:", Input->NumberOfDiskSuspendedProcesses1,
    		Input->DiskSuspendedProcessPIDs1);
    SPLineSetup(OutputLine, "SUS-DSK2:", Input->NumberOfDiskSuspendedProcesses2,
    		Input->DiskSuspendedProcessPIDs2);
    SPLineSetup(OutputLine, "SUS-DSK3:", Input->NumberOfDiskSuspendedProcesses3,
    		Input->DiskSuspendedProcessPIDs3);
